...
var map;
      function initMap() { // basic map data and style
        ...
        var pierCcontentString = '<div class="content">'+
            ...
            '<p>Need to get out of Manhattan but want to be home in time for dinner? Visit Pier C Park located in Hoboken, New Jersey. Take the PATH train to Hoboken and walk north along the water. Pier C Park is a great place to enjoy views of Manhattan’s entire west side. Downtown views are especially clear here, so be sure to come when it’s not overcast! Daytime and nighttime views are equally enjoyable so stay a couple hours to see the sunset. There are plenty of restaurants and bars so feel free to come hungry.</p>'+'<div class="directions"><a href="https://goo.gl/maps/i5H2hvmdBV32" target="_blank"><i class="fa fa-location-arrow" aria-hidden="true"></i> Take me here</a> <a href="https://kristyan-p.github.io/Final_Project/about.html" target="_blank"><i class="fa fa-building" aria-hidden="true"></i> About Cheap Viewz</a> <a href="https://kristyan-p.github.io/Final_Project/questionnaire.html" target="_blank"><i class="fa fa-repeat" aria-hidden="true"></i> Take quiz again</a></div>'+
            '</div>'+
            '</div>';
        ...
        govIslandmarker.addListener('click', function() {
         ...
         var ferrycontentString = '<div class="content">'+
            ...
            '<p>The Staten Island Ferry is on every NYC tourist agenda, and for good reason. For absolutely no cost you can see sweeping views of downtown Manhattan and the Statue of Liberty. To see the statue of Liberty, head to the right side of the ferry and go to the upstairs deck. For views of downtown, stay in the back of the ferry when departing Manhattan, and go to the front of the ferry when returning. Or, you can stay and get a slice at one of SI’s famous pizza joints.</p>'+'<div class="directions"><a href="https://goo.gl/maps/i5H2hvmdBV32" target="_blank"><i class="fa fa-location-arrow" aria-hidden="true"></i> Take me here</a> <a href="https://kristyan-p.github.io/Final_Project/about.html" target="_blank"><i class="fa fa-building" aria-hidden="true"></i> About Cheap Viewz</a> <a href="https://kristyan-p.github.io/Final_Project/questionnaire.html" target="_blank"><i class="fa fa-repeat" aria-hidden="true"></i> Take quiz again</a></div>'+
            '</div>'+
            '</div>';
